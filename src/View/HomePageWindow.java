...
//		frame.getContentPane().add(textPane_5);
		...
		lblByName.setBounds(671, 14, 89, 22);
		frame.getContentPane().add(lblByName);
		
		JLabel lblByKnd = new JLabel("BY KIND");
		lblByKnd.setBounds(671, 46, 89, 17);
		frame.getContentPane().add(lblByKnd);
		
		JButton btnWach = new JButton("");
		btnWach.setIcon(new ImageIcon("C:\\Users\\selig\\eclipse-workspace\\netflix.jpeg"));
		btnWach.setBounds(600, 519, 148, 34);
		frame.getContentPane().add(btnWach);
		
		JButton btnNewButton = new JButton("WATCH");
		...
		btnNewButton.setBounds(623, 488, 85, 21);
